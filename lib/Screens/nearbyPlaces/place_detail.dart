...
class PlaceDetailWidget extends StatefulWidget {
  ...
  const PlaceDetailWidget({Key? key, required this.placeId}) : super(key: key);

  // PlaceDetailWidget(String placeId, {Key? key}) : super(key: key) {
   ...
   // final result = await _places.searchNearbyWithRadius(location, 2500);
    ...
    var markerOptions = Marker(
        ...
        infoWindow: InfoWindow( title:
            "${placeDetail.name}", snippet: "${placeDetail.formattedAddress}"), markerId:MarkerId(location.toString()));
